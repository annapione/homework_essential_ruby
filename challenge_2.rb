...
loan_quotes.each do |the_bank|
  puts "The monthly payment from #{the_bank["bank"]} will be #{pmt((the_bank["annual_rate"]/12),number_of_monthly_payments, principal_amount).round(2)}"
